...
from riemapp.geometry import Polygon, Rectangle, RegularPolygon, Square
...
class ComplexMap:
    def __init__(
        self, f: Square | Rectangle | Polygon | RegularPolygon, transformation: callable
    ):
        self.f = f
    ...
    class Animate(Scene):
        def __init__(
            self,
            f: Square | Rectangle | Polygon | RegularPolygon,
